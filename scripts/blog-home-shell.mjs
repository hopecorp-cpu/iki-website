...
export function blogHomeShell(html) {
  ...
  return html.replace(/<header\b[\s\S]*?<\/header>/, () => blogHeader)
    ...
    .replace('</head>', '<link rel="stylesheet" href="/assets/iki-20260908/fonts.css"><link rel="stylesheet" href="/assets/iki-20260908/site.css?v=brand-20260914"><link rel="stylesheet" href="/assets/iki-20260908/blog-integration.css?v=brand-20260914"><script src="/assets/iki-20260908/site.js?v=navigation-4" defer></script></head>');
}
